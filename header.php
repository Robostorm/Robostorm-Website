    ...
    <div class="container-fluid">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                ...
                <li <?php if (basename($_SERVER['PHP_SELF']) == 'members.php') {
                    echo 'class="active"';
                } ?>><a href="members.php">Members</a></li>
                <li <?php if (basename($_SERVER['PHP_SELF']) == 'documents.php') {
                    echo 'class="active"';
                } ?>><a href="documents.php">Documents</a></li>
                <li <?php if (basename($_SERVER['PHP_SELF']) == 'events.php') {
                    echo 'class="active"';
